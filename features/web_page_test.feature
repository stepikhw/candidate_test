...
# 5. Проверял, что это имя скачанного файла совпадает с именем файла-установщика, указанного на сайте
  ...
  Функция: UI
    ...
    Сценарий: Подготовка директории для загрузки
      Дано очищаю директорию для загрузок


    Сценарий: Скачивание последнего стабильного релиза Ruby

      Когда захожу на страницу "https://www.ruby-lang.org/ru/"
      И нажимаю на вкладку с текстом "Скачать"
      То открывается страница "https://www.ruby-lang.org/ru/downloads/"
      Когда я нажимаю на ссылку на последний стабильный релиз
      И жду конца загрузки "30" секунд
      То директория содержит загруженный файл
      И имя скачанного файла совпадает с именем на сайте
